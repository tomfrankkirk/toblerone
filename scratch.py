...
#     work = range(2000)
#     results = [] 
#     for i, r in enumerate(tqdm.tqdm(p.imap(task, work), 
#         total=len(work), ascii=True)):
#         results.append(r)

#     print(results)

results = []
for c in tqdm.trange(100, bar_format='{l_bar}{bar} {elapsed} | {remaining}'):
    results.append(task(c))